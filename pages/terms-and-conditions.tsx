...
export default function TermsAndConditions(props: { isLoggedIn?: boolean }) {
  return (
    <>
      <div>
        <NavigationLanding isLoggedIn={props.isLoggedIn || false} />
        <Head>
          <title>StopSpend - Terms and Conditions</title>
        </Head>
        <Container
          style={{
            paddingTop: "6.5rem",
        ...
        >
          <Row>
            ...
            <p>Last updated: September 13, 2022</p>
            <p>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to StopSpend,
                  300 Lenora Street PMB 1274.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to StopSpend, accessible from{" "}
                  <a
                    href="https://www.stopspend.com/"
                    rel="external nofollow noopener"
                    target="_blank"
                  >
                    https://www.stopspend.com/
                  </a>
                </p>
              </li>
              <li>
            ...
            <ul>
              <li>By email: hello@stopspend.com</li>
            </ul>
          </Row>
        </Container>
      </div>
