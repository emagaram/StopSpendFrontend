...
export default function Privacy(props: { isLoggedIn?: boolean }) {
  return (
    <div>
      <NavigationLanding isLoggedIn={props.isLoggedIn || false} />
      <Head>
        <title>StopSpend - Privacy Policy</title>
      </Head>
      <Container
        style={{
          paddingTop: "6.5rem",
      ...
      >
        <Row>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                "We", "Us" or "Our" in this Agreement) refers to StopSpend, 300
                Lenora Street PMB 1274.
              </p>
            </li>
            <li>
              <p>
          ...
          <ul>
            <li>By email: privacy@stopspend.com</li>
          </ul>
          <p>
